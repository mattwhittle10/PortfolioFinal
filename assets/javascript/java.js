$(document).ready(function () {
  ...
  $("#appendArea").append(
    ...
    "<div class='card text-center' class='card'>" +
    "<a href='https://floating-lowlands-75824.herokuapp.com/' target='_blank'><img class='card-img-top' src='./assets/images/bookCave.png' alt='Card image cap'></a>" +
    "<div class='card-body'>" +
    ...
    "<div class='card text-center' class='card'>" +
    "<a href='https://drive.google.com/file/d/1w7lkGPJC6fYZFkJ4q1g8L2FJ5scBen_9/view' target='_blank'><img class='card-img-top' src='./assets/images/liri.jpg' alt='Card image cap'></a>" +
    "<div class='card-body'>" +
